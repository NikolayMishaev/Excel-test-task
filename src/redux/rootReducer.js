...
export function rootReducer(state, action) {
  ...
  switch (action.type) {
    ...
    case CHANGE_TEXT:
      ...
      // сохранил в переменной field значение св-ва, в котором хранится объект, куда будем переадавать координаты и значения ячеек с пом. ф-ии value + запись в св-во currentText
      field = 'dataState';
      return { ...state, dataState: value(state, field, action), currentText: action.data.value  };
    case CHANGE_STYLES:
